#include "UHH2/vectorlikeT//include/HypothesisHistsOwn.h"
...
vectorlikeTHists::vectorlikeTHists(Context & ctx, const string & dirname): Hists(ctx, dirname){
  ...
  */
  ...
  h_hyps           = ctx.get_handle<std::vector<vectorlikeTReconstructionHypothesis>>("TprimeHypotheses");
  h_is_tprime_reco = ctx.get_handle<bool>("is_tprime_reco");
  is_mc = ctx.get("dataset_type") == "MC";
  
}

void vectorlikeTHists::fill(const Event & event){
...
vectorlikeTHists::~vectorlikeTHists(){}
